...
const Auto = () => (
	<svg className="img-fluid grafik-usluge-1" viewBox="0 0 321.97 150.34">
		<defs>
			<clipPath id="prefix__clip-path-6" transform="translate(-189 -497)">
				<path className="prefix__cls-1" d="M236.35 504.53a60.24 60.24 0 00-23.1 38.16H287l7.41-38.16z" />
			</clipPath>
			<clipPath id="prefix__clip-path-3" transform="translate(-189 -497)">
				<path className="prefix__cls-1" d="M291.61 542.68H396l-31.77-38.13-65.22-.01-7.4 38.14z" />
			</clipPath>
			<clipPath id="prefix__clip-path-4" transform="translate(-189 -497)">
				<path
					className="prefix__cls-1"
					d="M364.23 504.54L396 542.69h44.41S389.62 497 371.24 497c-3.83 3.83-7 7.54-7 7.54"
				/>
			</clipPath>
			<clipPath id="prefix__clip-path" transform="translate(-189 -497)">
				<path className="prefix__cls-1" d="M189 497h321.97v150.34H189z" />
			</clipPath>
			<clipPath id="prefix__clip-path-8" transform="translate(-189 -497)">
				<path
					className="prefix__cls-1"
					d="M426.73 615.43a20.17 20.17 0 1020.16-20.16 20.17 20.17 0 00-20.16 20.16"
				/>
			</clipPath>
			<clipPath id="prefix__clip-path-9" transform="translate(-189 -497)">
				<path
					className="prefix__cls-1"
		...
		<g id="prefix__Layer_2" data-name="Layer 2">
			<g className="prefix__cls-2" id="prefix__Layer_1-2" data-name="Layer 1">
				<path className="prefix__cls-3" d="M5.79 76.19h291.02v30.57H5.79z" />
				<g className="prefix__cls-2">
					...
					/>
					<path className="prefix__cls-5" d="M207 45.69H102.61l7.45-38.16h60.52L207 45.69z" />
					<path
				...
				<g clipPath="url(#prefix__clip-path-3)">
					<path fill="url(#prefix__linear-gradient)" d="M102.61 7.53H207v38.15H102.61z" />
				</g>
				<g clipPath="url(#prefix__clip-path-4)">
					<path fill="url(#prefix__linear-gradient-2)" d="M175.23 0h76.18v45.69h-76.18z" />
				</g>
				<g className="prefix__cls-2">
					<path className="prefix__cls-3" d="M182.24 0H57.17l-9.82 7.53h128L182.24 0z" />
				</g>
				<g clipPath="url(#prefix__clip-path-6)">
					<path fill="url(#prefix__linear-gradient-3)" d="M24.25 7.53h81.17v38.16H24.25z" />
				</g>
				<g className="prefix__cls-2">
					<path
				...
				<g clipPath="url(#prefix__clip-path-8)">
					<path fill="url(#prefix__linear-gradient-4)" d="M237.73 98.27h40.33v40.33h-40.33z" />
				</g>
				<g clipPath="url(#prefix__clip-path-9)">
					<path fill="url(#prefix__linear-gradient-5)" d="M23.45 98.27h40.33v40.33H23.45z" />
				</g>
				<g className="prefix__cls-2">
					<path
						className="prefix__cls-4"
