...
export default class OnlinePolisa extends Component {
	componentDidMount() {
  		window.scrollTo(0, 0)
	}
	render() {
		return (
			<React.Fragment>
				<MetaTags>
					<title>Online polisa | Aura Osiguranje</title>
					...
					<meta property="og:title" content="Aura Osiguranje – Online polisa" />
					...
					<meta name="twitter:title" content="Aura Osiguranje – Online polisa" />
					{/* doddati sliku */}
