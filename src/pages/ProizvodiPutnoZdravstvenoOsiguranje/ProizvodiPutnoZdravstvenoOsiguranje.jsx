...
import SekcijaPutnoZdravstvenoOsiguranje from '../../sections/sectionsProizvodi/SekcijaPutnoZdravstvenoOsiguranje';
export default class ProizvodiRegistracijaNaRate extends Component {
	render() {
		return (
			<React.Fragment>
				<MetaTags>
					<title>Putno zdravstveno osiguranje | Aura Osiguranje</title>
					...
					<meta property="og:title" content="Putno zdravstveno osiguranje | Aura Osiguranje" />
					...
					<meta name="twitter:title" content="Putno zdravstveno osiguranje | Aura Osiguranje" />
					{/* doddati sliku */}
					<meta name="twitter:image" content="" />
					<meta name="google-site-verification" content="PaD0tWUPmrmT7bSI2Z6SD-lNz2zD1HnAS6_tC0_zXVo" />
				</MetaTags>
				<SekcijaPutnoZdravstvenoOsiguranje />
				<Footer />
			</React.Fragment>
		);
	}
