...
export default class ProizvodiRegistracijaNaRate extends Component {
	render() {
		return (
			<React.Fragment>
				<MetaTags>
					<title>Osiguranje preduzetnika | Aura Osiguranje</title>
					...
					<meta property="og:title" content="Osiguranje preduzetnika | Aura Osiguranje" />
					...
					<meta name="twitter:title" content="Osiguranje preduzetnika | Aura Osiguranje" />
					{/* doddati sliku */}
