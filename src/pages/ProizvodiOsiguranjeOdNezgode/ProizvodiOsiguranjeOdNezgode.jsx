...
export default class ProizvodiOsiguranjeOdNezgode extends Component {
	render() {
		return (
			<React.Fragment>
				<MetaTags>
					<title>Osiguranje od nezgoda | Aura Osiguranje</title>
					...
					<meta property="og:title" content="Osiguranje od nezgoda | Aura Osiguranje" />
					...
					<meta name="twitter:title" content="Osiguranje od nezgoda | Aura Osiguranje" />
					{/* doddati sliku */}
					<meta name="twitter:image" content="" />
					<meta name="google-site-verification" content="PaD0tWUPmrmT7bSI2Z6SD-lNz2zD1HnAS6_tC0_zXVo" />
				</MetaTags>
				<SekcijaOsiguranjeOdNezgode />
				<Footer />
			</React.Fragment>
		);
	}
